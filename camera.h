...
public:
	...
	inline virtual void DisplayCameraPosition() const = 0;
	...
	inline virtual void AddYaw(const float dt, const float value) = 0;
	inline virtual void subtractYaw(const float dt, const float value) = 0;

	inline virtual float GetPitch() const = 0;
	inline virtual void SetPitch(const float arg) = 0;
	inline virtual void AddPitch(const float dt, const float value) = 0;
	inline virtual void subtractPitch(const float dt, const float value) = 0;

	inline virtual float GetRoll() const = 0;
	inline virtual void SetRoll(const float arg) = 0;
	inline virtual void AddRoll(const float dt, const float value) = 0;
	inline virtual void subtractRoll(const float dt, const float value) = 0;
